            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/topic/crypto/trading" className="text-zinc-400 hover:text-indigo-400 text-sm transition-colors">Crypto & DeFi</Link></li>
                  <li><Link href="/topic/ai/tooling" className="text-zinc-400 hover:text-indigo-400 text-sm transition-colors">Artificial Intelligence</Link></li>
                  <li><Link href="/topic/automation/workflows" className="text-zinc-400 hover:text-indigo-400 text-sm transition-colors">Automation</Link></li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li><Link href="/about" className="text-zinc-400 hover:text-indigo-400 text-sm transition-colors">About</Link></li>
                  <li><Link href="/contact" className="text-zinc-400 hover:text-indigo-400 text-sm transition-colors">Contact</Link></li>
                  <li><Link href="/privacy" className="text-zinc-400 hover:text-indigo-400 text-sm transition-colors">Privacy</Link></li>
                  <li><Link href="/terms" className="text-zinc-400 hover:text-indigo-400 text-sm transition-colors">Terms</Link></li>
                  <li><Link href="/affiliate-disclosure" className="text-zinc-400 hover:text-indigo-400 text-sm transition-colors">Affiliate Disclosure</Link></li>
                </ul>
              </div>
            </div>
