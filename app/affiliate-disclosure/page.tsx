    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      <div className="card-elevated p-8 md:p-12">
        ...
        <div className="prose prose-invert prose-zinc space-y-6">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">How Affiliate Marketing Works</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <p className="text-stone-700 leading-relaxed">
            Decryptica is committed to editorial independence. Our affiliate relationships are disclosed clearly on this page and throughout the site. If you have questions about specific affiliate relationships, please contact us at <a href="mailto:brian@renegadereels.com" className="text-red-800 hover:text-red-700">brian@renegadereels.com</a>.
          </p>
          
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">Updates to This Disclosure</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">Business Information</h2>
          <div className="p-6 bg-stone-50  space-y-2 text-stone-700">
            <p><strong className="text-stone-950">Legal Entity:</strong> Renegade Reels LLC</p>
