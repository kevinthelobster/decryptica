...
export default function SubmitPageClient() {
    ...
    return (
      <div className="max-w-2xl mx-auto px-6 py-20 text-center">
        ...
        <p className="text-zinc-400 text-lg mb-8">
          Your prompt is in the queue. Brian will review it shortly.
        </p>
  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="mb-10">
        <h1 className="font-display font-bold text-4xl text-white mb-3">Submit a Prompt</h1>
        <p className="text-zinc-400">
          Share your OpenClaw automation setup with the community. Approved prompts go live immediately.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div>
          ...
          <p className="text-xs text-zinc-500 mb-3">One step per line. These will be numbered automatically.</p>
          <textarea
