...
export const metadata: Metadata = {
  ...
  description: 'Free AI model price calculator to compare GPT-5.6, Claude, Gemini, DeepSeek, Grok, Mistral and more. Find the cheapest AI provider for your use case. Updated August 24, 2026.',
  ...
  openGraph: {
    ...
    description: 'Compare AI API costs across OpenAI, Anthropic, Google, DeepSeek, xAI, Mistral, and more. Updated August 24, 2026.',
    type: 'website',
  },
};
  ...
  "mainEntity": [
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "GPT-5.6 Sol costs $2.00 per 1M input tokens and $10.00 per 1M output tokens on standard OpenAI API pricing as of August 24, 2026."
      }
    },
    {
      "@type": "Question",
...
function ToolCTACompare() {
  return (
    <div className="p-5 bg-white border border-stone-200 ">
      ...
      <p className="text-xs text-stone-500">Current production models across major API providers — updated August 24, 2026</p>
    </div>
  );
}
