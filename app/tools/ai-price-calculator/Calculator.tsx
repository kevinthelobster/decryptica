...
export const PROVIDERS = [
  ...
  { id: "openai-gpt-5.5", name: "GPT-5.5", provider: "OpenAI", input: 2.5, output: 15.0, supports: ["text", "vision", "function", "reasoning", "coding"], contextWindow: 1000000, color: "#10a37f", link: "https://developers.openai.com/api/docs/pricing", openSource: false },
  { id: "openai-gpt-5.5-pro", name: "GPT-5.5 Pro", provider: "OpenAI", input: 15.0, output: 90.0, supports: ["text", "vision", "function", "reasoning", "coding"], contextWindow: 1000000, color: "#10a37f", link: "https://developers.openai.com/api/docs/pricing", openSource: false },
  { id: "openai-gpt-5.4", name: "GPT-5.4", provider: "OpenAI", input: 1.25, output: 7.5, supports: ["text", "vision", "function", "reasoning", "coding"], contextWindow: 1000000, color: "#10a37f", link: "https://developers.openai.com/api/docs/pricing", openSource: false },
  { id: "openai-gpt-5.4-mini", name: "GPT-5.4 Mini", provider: "OpenAI", input: 0.375, output: 2.25, supports: ["text", "vision", "function", "reasoning"], contextWindow: 200000, color: "#10a37f", link: "https://developers.openai.com/api/docs/pricing", openSource: false },
  { id: "openai-gpt-5.4-nano", name: "GPT-5.4 Nano", provider: "OpenAI", input: 0.1, output: 0.625, supports: ["text", "function"], contextWindow: 200000, color: "#10a37f", link: "https://developers.openai.com/api/docs/pricing", openSource: false },
  ...
  // Cohere
  { id: "cohere-command-a-plus-05-2026", name: "Command A+ 05-2026", provider: "Cohere", input: 2.5, output: 10.0, supports: ["text", "vision", "function", "reasoning"], contextWindow: 256000, color: "#f47b5a", link: "https://docs.cohere.com/docs/command-a", openSource: true },
