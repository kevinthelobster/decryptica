...
export default async function BlogPostPage({ params }: PostPageProps) {
  ...
  // For now, redirect to the static article if it exists
  // In production, this would load from a content index
  ...
  // This would normally be fetched from content
  const post = {
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        <div className="grid lg:grid-cols-4 gap-8">
          ...
          <article className="lg:col-span-3">
            ...
            {/* Article Content - simplified for dynamic route */}
