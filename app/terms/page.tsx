    ...
    <div className="max-w-4xl mx-auto px-6 py-12">
      <div className="card-elevated p-8 md:p-12">
        ...
        <div className="prose prose-invert prose-zinc space-y-6">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">5. Intellectual Property</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">6. User Conduct</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">7. Disclaimer of Warranties</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">8. Limitation of Liability</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">9. Privacy</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">10. Changes to These Terms</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">11. Governing Law</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">12. Contact</h2>
          <p className="text-stone-700 leading-relaxed">
          ...
          <h2 className="font-display text-xl font-semibold text-stone-950 mt-8 mb-3">13. Business Information</h2>
