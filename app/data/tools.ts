...
export const tools: DecrypticaTool[] = [
  ...
  {
    slug: 'local-ai-hardware-calculator',
    title: 'Local AI Hardware Calculator',
    shortTitle: 'Local AI hardware',
    kicker: 'Live calculator',
    href: '/tools/local-ai-hardware-calculator',
    category: 'ai',
    track: 'Local AI',
    description:
      'Enter your Mac or PC specs to estimate which local AI model sizes should run comfortably, slowly, or not at all.',
    bestFor: 'Ollama, LM Studio, private AI, and local model beginners',
    articleMatch: ['local ai', 'ollama', 'lm studio', 'llama.cpp', 'hardware', 'macbook', 'gpu', 'vram', 'ram', 'local model'],
    leadMagnetSlug: 'ai-model-pricing-sheet',
  },
  {
    slug: 'local-ai-model-requirements',
    title: 'Local AI Model Requirements Calculator',
    shortTitle: 'Local model requirements',
    kicker: 'Live calculator',
    href: '/tools/local-ai-model-requirements',
    category: 'ai',
    track: 'Local AI',
    description:
      'Choose a target local model size and see the RAM, VRAM, storage, and machine tier you should have before running it.',
    bestFor: 'Hardware buying decisions and local AI model selection',
    articleMatch: ['local ai', 'ollama', 'llama', 'qwen', 'deepseek coder', 'model requirements', 'vram', 'ram', 'quantization'],
    leadMagnetSlug: 'ai-model-pricing-sheet',
  },
  {
