      ...
      <div className="card-elevated p-8 md:p-12">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          <div className="p-6 bg-zinc-800/30 rounded-xl">
            <h2 className="font-display font-semibold text-white mb-2">General Contact</h2>
          ...
          <div className="p-6 bg-zinc-800/30 rounded-xl">
            <h2 className="font-display font-semibold text-white mb-2">Business Inquiries</h2>
            <p className="text-zinc-300 mb-3">
        ...
        <div className="mt-6 p-6 bg-zinc-800/30 rounded-xl">
          <h2 className="font-display font-semibold text-white mb-3">What helps us reply faster</h2>
        ...
        <div className="mt-6 p-6 bg-zinc-800/30 rounded-xl">
          <h2 className="font-display font-semibold text-white mb-3">Response expectations</h2>
        ...
        <div className="mt-6 p-6 bg-zinc-800/30 rounded-xl">
          <h2 className="font-display font-semibold text-white mb-3">Legal and privacy requests</h2>
          ...
          <div className="flex flex-wrap gap-4 text-sm">
            ...
            <Link href="/affiliate-disclosure" className="text-indigo-400 hover:text-indigo-300">Affiliate Disclosure</Link>
          </div>
        </div>
        ...
        <div className="mt-6 p-6 bg-zinc-800/30 rounded-xl">
          ...
          <p className="text-zinc-300 leading-relaxed">
            ...
            <strong className="text-white">State of Registration:</strong> Ohio, United States<br />
            <strong className="text-white">Website:</strong> decryptica.com
          </p>
        </div>
      </div>
    </div>
